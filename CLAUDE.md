...
- **Opus 4.7 for synthesis**: locked in spec, no downgrade. Structured outputs were unavailable on Greg's key, so we parse JSON from the system prompt instead. Works reliably.
